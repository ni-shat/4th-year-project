    ...
    $(document).ready(function (e) {
        ...
        $("#form").on('submit', function (e) {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    $('#form').css("opacity", ".5");
                    // $("#form").find("button").css("background-color", "rgba(225, 225, 225, 0.937)");
                    //  $("#form").find("button").text("Uploading...");
                    //  $("#form").find()
                ...
                error: function () {
                    console.log(error);
                    // $("#form").find("button").text("Failed to upload!");
                    // $("#form").find("button").css("background-color", "rgba(189, 53, 53, 0.937)");
                    // $("#form").find("button").css("color", "white");	
                }
